...
public class Sphere extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1=findViewById(R.id.editTextNumberDecimal29);
        ed2=findViewById(R.id.editTextNumberDecimal30);
        ed3=findViewById(R.id.editTextNumberDecimal31);
        ed4=findViewById(R.id.editTextNumberDecimal32);
    }
